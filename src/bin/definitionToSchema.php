...
$shortopts .= "u:";  // Required - URL root for schema
$shortopts .= "o:";  // Required - path for generated schema objects

$options = getopt($shortopts);

if (empty($options['s']) || empty($options['s'])) {
    exit;
}
...
define('SCHEMADOCDIR', realpath($options['u']));
